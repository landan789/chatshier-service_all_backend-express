module.exports = (function() {
    ...
    BotController.prototype._findPlatformUids = function(appId, appType) {
    ...
    BotController.prototype.activateMenu = function(req, res) {
        ...
        return controllerCre.AppsRequestVerify(req).then((checkedAppIds) => {
            ...
            return BotController.prototype._createBot(appId);
        }).then((app) => {
            if (!app) {
            ...
            return botSvc.setRichMenuImage(botMenuId, image, appId).then((result) => {
                ...
                return BotController.prototype._findPlatformUids(appId, appType).then((platformUids) => {
    ...
    BotController.prototype.deactivateMenu = function(req, res) {
        ...
        return controllerCre.AppsRequestVerify(req).then((checkedAppIds) => {
            ...
            return BotController.prototype._findPlatformUids(appId, appType);
        }).then((platformUids) => {
            return Promise.all(platformUids.map((platformUid) => {
