...
$(document).ready(function() {
  ...
  if(window.location.pathname === '/chat') {
    ...
    auth.onAuthStateChanged(currentUser => {
      ...
      socket.emit('develop update bot', userId);
