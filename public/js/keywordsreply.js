            ...
            if (appsKeywordreplis && appsKeywordreplis[appId]) {
                ...
                for (var keywordreplyId in keywordreplies) {
                    ...
                    '<tr id="' + keywordreplyId + '" data-title="' + appId + '">' +
                        ...
                        '<td>' +
                            '<button type="button" class="m-1 btn btn-border btn-light fas fa-edit update" id="edit-btn" data-toggle="modal" data-target="#keywordreply_edit_modal" aria-hidden="true"></button>' +
                            '<button type="button" class="m-1 btn btn-danger fas fa-trash-alt remove" id="delete-btn"></button>' +
                        '</td>' +
                    '</tr>';
